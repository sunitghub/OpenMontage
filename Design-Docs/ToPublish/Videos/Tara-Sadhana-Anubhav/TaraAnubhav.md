...
> - **Tara apparition (1):** `Tara-Maa-3.jpg` + `Room-Ref.jpg`
> - **Room scenes (3–10):** always include `Room-Ref.jpg` to anchor the modern interior
> - **Character scenes:** add `Sadhak-A.jpg` or `Sadhak-B.jpg` as needed
> - **Guru scene (2):** `Guru-Ref.jpg` + `Sadhak-A.jpg` (no room ref needed)
> - **Detail shots (6, 8, 9):** `Room-Ref.jpg` + `Tara-Maa-3.jpg` for style anchor

**1. Maa Tara appears — divine opening**

> **GPT-4o note:** Upload `Tara-Maa-3.jpg` + `Room-Ref.jpg` + `Sadhak-B.jpg`

	painterly AI devotional illustration, Hindustani folk-story art style, wide landscape composition, full interior view of the modern rose-pink room (ref: Room-Ref.jpg) — Maa Tara (ref: Tara-Maa-3.jpg) hovering in the center of the room, slightly zoomed out to show the full room around her, her deep blue radiant form luminous and divine, four arms — upper-right holding curved silver khadga, upper-left holding blue lotus, lower-right kartri scissors, lower-left kapala skull cup — a large brilliant golden halo radiating behind her head, right palm turned outward in abhaya mudra with a soft golden ray of divine light streaming gently from her palm downward — in the foreground at the base of the image Sadhak-B (ref: Sadhak-B.jpg) kneeling with forehead nearly touching the floor in full prostration, pink sadhana attire visible, rudraksha mala resting on the ground, overwhelmed with reverence and awe — pink walls and window with white curtains visible on both sides, divine golden-white radiance flooding the room, ceramic tiled floor reflecting her glow, awe-inspiring and captivating, no text no watermark
...
**7. Sadhak-A arranging the rice lotus**
